...
import com.taotao.service.core.entity.ItemParamItem;
import com.taotao.service.core.entity.ItemParamItemExample;
...
public interface ItemParamItemMapper {
    ...
    ItemParamItem lockSelectByPrimaryKey(String id);
}